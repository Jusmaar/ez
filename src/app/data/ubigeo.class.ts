...
// Devuelve el nombre de departamento
    getDepartamento(depId:string){
        let departamento;
        for(let i in this.ubigeo){
            if ((this.ubigeo[i]['departamento'] == depId) && (this.ubigeo[i]['provincia'] === '00') && (this.ubigeo[i]['distrito'] === '00')) {
                departamento = this.ubigeo[i]['nombre'];
            }
        }
        return departamento;
    }
// Devuelve el nombre de la provincia
    getProvincia(depId:string, provId:string){
        let provincia;
        for(let i in this.ubigeo){
            if ((this.ubigeo[i]['departamento'] == depId) && (this.ubigeo[i]['provincia'] === provId) && (this.ubigeo[i]['distrito'] === '00')) {
                provincia = this.ubigeo[i]['nombre'];
            }
        }
        return provincia;
    }
// Devuelve el nombre del distrito
    getDistrito(depId:string, provId:string, distId:string){
        let distrito;
        for(let i in this.ubigeo){
            if ((this.ubigeo[i]['departamento'] == depId) && (this.ubigeo[i]['provincia'] === provId) && (this.ubigeo[i]['distrito'] === distId)) {
                distrito = this.ubigeo[i]['nombre'];
            }
        }
        return distrito;
    }
    ...
    getUbigeoDepartamento(){
        ...
        for(let i in this.ubigeo){
            if ((this.ubigeo[i]['provincia'] === '00') && (this.ubigeo[i]['distrito'] === '00')) {
                listaDepartamento[j]=this.ubigeo[i];
                j++;
            }
        }
    ...
    getUbigeoProvincia(depa){
        ...
        for(let i in this.ubigeo){
            if ((this.ubigeo[i]['departamento'] == depa) && (this.ubigeo[i]['provincia'] != '00') && (this.ubigeo[i]['distrito'] === '00')) {
                listaProvincia[j]=this.ubigeo[i];
                j++;
            }
        }
    ...
    getUbigeoDistrito(depart, provin){
        ...
        for(let i in this.ubigeo){
            if ((this.ubigeo[i]['departamento'] == depart) && (this.ubigeo[i]['provincia'] == provin) && (this.ubigeo[i]['distrito'] != '00')) {
                listaDistrito[j]=this.ubigeo[i];
                j++;
            }
        }
        // console.log( listaDistrito );
